...
### Academic Research Portfolio and Published Research Contributions

![Research Papers](https://img.shields.io/badge/Research%20Papers-1-success?style=for-the-badge)
![Journal Publication](https://img.shields.io/badge/Journal-Gradiva%20Review-blue?style=for-the-badge)
![Research Domain](https://img.shields.io/badge/Domain-IoT%20%26%20Embedded%20Systems-orange?style=for-the-badge)
![Publication Year](https://img.shields.io/badge/Published-2022-red?style=for-the-badge)
![Research Status](https://img.shields.io/badge/Status-Published-success?style=for-the-badge)
...
## 🏠 Home Automation & Vehicle Speed Detection Using IoT with Google Assistant
...
| **Academic Year** | Final Year Project (2021–2022) |
...
The command is transmitted through cloud services using:
...
The NodeMCU (ESP8266) receives the command through Wi-Fi communication.

↓

### Step 4 – Device Processing

The embedded controller processes the received command and controls the connected electrical appliances.

↓

### Step 5 – Vehicle Speed Monitoring

The system simultaneously monitors vehicle speed using embedded sensors and processes the collected data.

↓

### Step 6 – Output

The system performs intelligent automation by:
...
Research-Publications/
│
├── Paper_Publication_Certificate.jpg
├── Home_Automation_and_Vehicle_Speed_Detection_Research_Paper.pdf
└── README.md
```
...
Thank you for taking the time to explore my academic research publication and research contributions.
